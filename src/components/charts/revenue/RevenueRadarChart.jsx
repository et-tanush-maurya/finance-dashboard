...
export default function RevenueRadarChart({ data, title, subtitle }) {
  // Take last 6 months
  const last6 = data.slice(-6).map(d => ({
    ...d,
    month: d.month.split(' ')[0], // shorten to "Jan", "Feb" etc.
  }));
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 border-t-4 border-t-[#F5CA23] p-8">
      ...
      <ChartContainer config={chartConfig} className="mx-auto w-full max-w-[500px] aspect-square">
